...
class DummyModel extends AMLO\Model\AbstractAMLO
{
	...
	public function addTaxIDProxy($p1, $p2, $p3)
	{
		return $this->addTaxID($p1, $p2, $p3);
	}
	public function addVatIDProxy($p1, $p2, $p3)
	{
		return $this->addVatID($p1, $p2, $p3);
	}
	public function addRiskAnnotationProxy($p1, $p2, $p3, $p4)
	{
		return $this->addRiskAnnotation($p1, $p2, $p3, $p4);
	}
	public function addRiskRatingProxy($p1, $p2, $p3, $p4, $p5)
	{
		return $this->addRiskRating($p1, $p2, $p3, $p4, $p5);
	}
}

class AbstractAMLOTest extends TestCase
{
